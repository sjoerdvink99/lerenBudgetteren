    ...
    <div className='product'>
      <div className='product__container'>
        ...
        <Typography variant='p'>
          ...
          With Leren Budgetteren, you can manage your income, gain clear insight
          in how much money you really have, and how you can best devide it over
          your expenditures. We know this can be very challenging, which is why
          with Leren Budgetteren we help you through every step of the way!
        </Typography>
      </div>
    </div>
  );
